...
import main.model.camp.DisplayCampsEnrolled;
import main.utils.exception.ModelNotFoundException;

/**
 * A class that represents a user
 */
public interface User extends Model, DisplayCampsEnrolled {
    /**
     ...
     */
    String getEmail();
    boolean getNotFirstTimeLogin();
    void setNotFirstTimeLogin();
    /**

...
public class AccountManager {
     ...
     * @param faculty  the faculty of the user to be registered
...
//        }
    ...
    private static void loadStudents() {
        List<List<String>> studentList = CSVReader.read(Location.RESOURCE_LOCATION + "/resources/student list.csv", true);
    ...
    /**
     * Loads the staff from the CSV resource file
     */
    private static void loadStaff() {
        List<List<String>> facultyList = CSVReader.read(Location.RESOURCE_LOCATION + "/resources/staff_list.csv", true);
    ...
    public static User getByDomainAndID(UserType userType, String ID) throws ModelNotFoundException {
        return switch (userType) {
            case STUDENT, COMMITTEE -> StudentRepository.getInstance().getByID(ID);

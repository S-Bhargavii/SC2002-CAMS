...
public class UserFinder {
     ...
     */
   private static User findCommittee(String userID) throws ModelNotFoundException {
        return CommitteeRepository.getInstance().getByID(userID); //CoordinatorRepository.getInstance().getByID(userID);
    }
    ...
    public static User findUser(String userID, UserType userType) throws ModelNotFoundException {
        return switch (userType) {
            ...
            case COMMITTEE -> findCommittee(userID);
        };
    }
}
